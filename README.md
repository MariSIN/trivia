...
Foi desenvolvido um jogo de perguntas e respostas baseado no jogo _**Trivia**_(tipo um show do milhão americano rs)_ utilizando _React e Redux_, desenvolvendo em grupo suas funcionalidades de acordo com as demandas definidas em um quadro _Kanban_.  A partir das demandas, temos uma aplicação onde a pessoa usuária poderá:
