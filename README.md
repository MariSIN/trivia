...
:paperclip: https://trivia-gold-chi.vercel.app/
  ...
  Foi desenvolvido em grupo um jogo de perguntas e respostas baseado no jogo  <strong>Trivia</strong> (tipo um show do milhão americano rs) utilizando React e Redux. Suas funcionalidades foram de acordo com as demandas definidas em um quadro _Kanban_.  A partir dessas demandas, temos uma aplicação onde a pessoa usuária poderá:
